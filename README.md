...
- **ENCODING & SECURITY**
  - [Base64 Encoder/Decoder](https://qubittool.com/en/tools/base64-encoder)
  - [URL Encoder/Decoder](https://qubittool.com/en/tools/url-encoder)
  - [MD5 Hash Generator](https://qubittool.com/en/tools/md5-generator)
  - [JWT Generator](https://qubittool.com/en/tools/jwt-generator)
  - [Hash Generator](https://qubittool.com/en/tools/hash-generator)
  - [Password Generator](https://qubittool.com/en/tools/password-generator)
  - [HTML Entity Encoder/Decoder](https://qubittool.com/en/tools/html-entity-encoder)
  - [ASCII/Unicode Converter](https://qubittool.com/en/tools/ascii-unicode-converter)
- **CONVERTERS**
  - [Unit Converter](https://qubittool.com/en/tools/unit-converter)
  - [Base Converter](https://qubittool.com/en/tools/base-converter)
  - [XML to JSON Converter](https://qubittool.com/en/tools/xml-to-json)
  - [JSON to XML Converter](https://qubittool.com/en/tools/json-to-xml)
  - [YAML to JSON Converter](https://qubittool.com/en/tools/yaml-to-json)
